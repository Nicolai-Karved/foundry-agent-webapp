...
- **Templates** are stored in the skill directory at `.github/skills/planning-with-files/templates/`
...
Before long-running, high-complexity, or research-heavy tasks:
...
### 1. Create Plan First
For complex tasks, create `task_plan.md` before broad execution. For routine, low-risk local edits, use lightweight planning instead.
...
- Single-file edits
- Quick lookups
- Routine low-risk fixes with clear acceptance criteria
